...
int in = 0;         //Minko arent these already defined?
int out = 0;        //Minko arent these already defined?
int buffer[100];  //Minko arent these already defined?
...
void ADCreader::run()
{
    ...
    while(running) {
      ...
      int value = readData(fd)-0x8000;  //Minko for -ve?
      buffer[in] = value;
